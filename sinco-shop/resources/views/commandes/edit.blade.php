    ...
    <div class="bg-white p-8 rounded-lg shadow-lg">
        ...
        <form action="{{ route('commandes.update', $order->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="client_name" name="client_name" class="form-input mt-1 block w-full" value="{{ $order->client_name }}" required>
            </div>
            <div class="mb-4">
                <label for="order_date" class="block text-gray-700">Date de la Commande</label>
                <input type="date" id="order_date" name="order_date" class="form-input mt-1 block w-full" value="{{ $order->order_date }}" required>
            </div>
