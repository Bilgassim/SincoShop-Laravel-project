...
<body>
    <header class="bg-gray-800 text-white p-4 relative z-50">
        <nav class="container mx-auto flex justify-between items-center">
            <a href="{{ route('home') }}" class="text-2xl font-bold">Sinco Shop</a>
            <div class="hidden md:flex space-x-6">
                <a href="{{ route('dashboard') }}" class="hover:text-gray-300">Tableau de Bord</a>
                <a href="{{ route('rapports.index') }}" class="hover:text-gray-300">Rapports</a>
                <a href="{{ route('produits.index') }}" class="hover:text-gray-300">Produits</a>
                <a href="{{ route('commandes.index') }}" class="hover:text-gray-300">Commandes</a>
                <a href="{{ route('fournisseurs.index') }}" class="hover:text-gray-300">Fournisseurs</a>
            </div>
            <div class="md:hidden">
        ...
        <!-- Menu mobile -->
        <div id="mobile-menu" class="fixed inset-0 bg-gray-900 bg-opacity-90 text-white p-8 transform translate-x-full transition-transform duration-300 ease-in-out z-50">
