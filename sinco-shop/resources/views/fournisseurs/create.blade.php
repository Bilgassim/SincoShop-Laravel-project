<x-master titre="Ajouter un Fournisseur">
    <!-- Bouton de retour -->
    ...
    <div class="bg-white p-8 rounded-lg shadow-lg">
        <h2 class="text-2xl font-bold mb-6">Ajouter un Nouveau Fournisseur</h2>
        <form action="{{ route('fournisseurs.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="phone" name="contact" class="form-input mt-1 block w-full" required>
            </div>
